...
fun BuildResult.shouldHaveTaskWithAnyOutcome(taskPath: String, vararg outcomes: TaskOutcome) {
  this shouldHaveRunTask taskPath shouldHaveAnyOutcome outcomes.asList()
}
...
): Unit = shouldHaveTasksWithOutcome(taskPathToExpectedOutcome.asIterable())
