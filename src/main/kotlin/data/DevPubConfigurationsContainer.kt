...
class DevPubConfigurationsContainer(
  ...
  private val testMavenPublicationDependencies: NamedDomainObjectProvider<Configuration> =
  ...
  val testMavenPublicationConsumable: NamedDomainObjectProvider<Configuration> =
